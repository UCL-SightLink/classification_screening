...
MAPBOX_API_KEY = ("")  # Put API Key here
crosswalk_images_folder = "crosswalk_images"


def get_cross_walk_location(location_geo_code, bounds=0.1):
...
def get_mapbox_aerial_image(location, output_file_name, zoom=20, size="600x600", style="satellite-v9",
